...
public class TNTProjectile extends EntityTNTPrimed implements CustomProjectile, IProjectile {
	...
	private List<TypedRunnable<TNTProjectile>> typedRunnables = new ArrayList();
	...
	public void h() {
		...
		if (isAlive()) {
			...
			for (TypedRunnable<TNTProjectile> r : this.typedRunnables) {
				r.run(this);
			}
		}
	}
	...
	public void b_(EntityHuman entityhuman) {
		if ((entityhuman == getSource()) && (this.age <= 3)) {
			return;
		}
	...
	public void addTypedRunnable(TypedRunnable<? extends CustomProjectile> r) {
		this.typedRunnables.add((TypedRunnable<TNTProjectile>) r);
	}
